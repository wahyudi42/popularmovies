...
public class WatchItSyncAdapter extends AbstractThreadedSyncAdapter {
    public final String LOG_TAG = WatchItSyncAdapter.class.getSimpleName();
    // Interval at which to sync with the weather, in seconds.
    // 60 seconds (1 minute) * 180 = 3 hours
    public static final int SYNC_INTERVAL = 24 * 60 * 60;
    public static final int SYNC_FLEXTIME = SYNC_INTERVAL/3;

    public WatchItSyncAdapter(Context context, boolean autoInitialize) {
    ...
    private static void onAccountCreated(Account newAccount, Context context) {
         ...
         */
        WatchItSyncAdapter.configurePeriodicSync(context, SYNC_INTERVAL, SYNC_FLEXTIME);
